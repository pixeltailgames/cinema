...
LANG.Theater_SeekQuery			= "HH:MM:SS o en segundos totales (e.g. 1:30:00 ó 5400)"
...
LANG.Settings_HDLabel				= "Reproducción de video en alta-definición"
LANG.Settings_HDTooltip				= "Habilite la selección para videos en alta-definición. (Si necesario)"
